...
\item $u_{ikj}$ is the binary decision variable assodicated with the...
\end{itemize}
...
\begin{align}
\sum_{j = 1}^{Z} x_{ikj} &\leq c_{ik} & i \in \{1, \ldots, X\}, k \in \{1, \ldots, Y\} \\
\sum_{i = 1}^{X} x_{ikj} &\leq d_{kj} & k \in \{1, \ldots, Y\}, j \in \{1, \ldots, Z\} \\
\sum_{k = 1}^{Y} x_{ikj} &\leq r & i \in \{1, \ldots, X\}, j \in \{1, \ldots, Z\} \\
